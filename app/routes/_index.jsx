...
const categories = [
  ...
  { name: 'Sale', href: '#', imageSrc: promoImg5 },
]
const collections = [
  {
    ...
    <div className="bg-white">
      ...
      <div className="relative bg-gray-900">
        ...
        <div aria-hidden="true" className="absolute inset-0 overflow-hidden">
          ...
          /> */}
          {/* <HeroVideo /> */}
          <video className="h-full w-full object-cover object-center" controls autoPlay loop muted>
                ...
                <div>
                  <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="hidden lg:flex lg:flex-1 lg:items-center">
                      <a href="#">
                        <span className="sr-only">ONELIVE</span>
                        <img
        ...
        <div className="relative mx-auto flex max-w-3xl flex-col items-center px-6 py-4 text-center sm:py-64 lg:px-0">
          <h1 className="text-4xl font-bold tracking-tight text-white lg:text-6xl">Dare to go headless!</h1>
      ...
      <main>
        ...
        <section
          ...
          className="mx-auto max-w-7xl px-4 pt-24 sm:px-6 sm:pt-4 lg:px-8"
        >
          <div className="relative overflow-hidden rounded-lg">
            ...
            <div className="relative bg-gray-900 bg-opacity-75 px-6 py-4 sm:px-12 sm:py-40 lg:px-16">
        ...
        {/* Featured section */}
        <section aria-labelledby="comfort-heading" className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-4 lg:px-8">
          <div className="relative overflow-hidden rounded-lg">
            <div className="absolute inset-0">
              <img
                src={promoImg5}
