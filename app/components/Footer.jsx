    ...
    <footer className="bg-zinc-900" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-400">Copyright &copy; 2024 ONELIVE, LLC</p>
        </div>
      </div>
    </footer>
  )
...
const navigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/OneLiveMedia/',
      icon: (props) => (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/onelive/',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'X',
      href: 'https://twitter.com/onelivellc',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
